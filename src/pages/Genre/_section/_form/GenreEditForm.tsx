...
import { useGenreUpdate } from '@/services/genre';
...
const GenreEditForm = memo(() => {
  const { genreId, genre, setDrawerMode } = useGenreStore();
  ...
  const { isPending, mutateAsync: update, error } = useGenreUpdate(genreId);
