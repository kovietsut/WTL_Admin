        ...
        <Stack sx={styles.wrap}>
          <Card variant="outlined" component={Stack} p={3} spacing={1}>
            ...
            <Typography variant="button">
              button. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos blanditiis
              tenetur
            </Typography>
          ...
          <Card component={Stack} spacing={2} p={3}>
            <ToggleButtonGroup
              color="primary"
              value={toggleValue}
              exclusive
          ...
          <Card component={Stack} spacing={2} p={3} direction="row">
