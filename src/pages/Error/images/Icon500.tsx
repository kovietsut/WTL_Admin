    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g>
          ...
          <g>
            {' '}
            <path d="M476.665,238.897c-0.433-5.617-5.331-9.834-10.953-9.385c-5.617,0.433-9.819,5.337-9.385,10.953 c2.197,28.501-1.793,57.705-11.539,84.458c-1.928,5.292,0.8,11.146,6.092,13.074c1.152,0.42,2.331,0.619,3.49,0.619 c4.164,0,8.076-2.571,9.584-6.711C474.688,302.439,479.084,270.278,476.665,238.897z"></path>{' '}
          </g>{' '}
        </g>{' '}
        <g>
          {' '}
          <g>
            {' '}
            <path d="M469.409,197.204c-0.882-3.215-1.851-6.452-2.879-9.623c-1.737-5.36-7.491-8.296-12.847-6.558 c-5.359,1.737-8.295,7.489-6.558,12.847c0.933,2.878,1.811,5.818,2.613,8.735c1.243,4.528,5.349,7.502,9.829,7.502 c0.893,0,1.802-0.118,2.707-0.366C467.707,208.247,470.9,202.636,469.409,197.204z"></path>{' '}
          </g>{' '}
        </g>{' '}
      </g>
    </svg>
