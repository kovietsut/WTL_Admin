import componentsOverride from '@/libs/theme/overrides';
...
export default function ThemeContrast({ children }: Props) {
  ...
  const themeOptions: ThemeOptions = useMemo(
    () => ({
      ...
      components: {
        MuiCard: {
          defaultProps: {
            variant: themeContrast === 'bold' ? 'outlined' : 'elevation',
          },
          // styleOverrides: {
    ...
    [defaultTheme, themeContrast, styles.bgBold, styles.bgDefault]
  );
  ...
  theme.components = {
    ...
    MuiCard: themeOptions.components?.MuiCard as Components['MuiCard'],
  };
